...
-- Inserting 2 copies for each book
...
-- Inserting 12 loan records
INSERT INTO loan_record (loan_id, reader_id, copy_id, loan_date, return_date) VALUES
